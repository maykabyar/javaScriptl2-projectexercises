...
var getsortzam1btn = document.getElementById('sortzaml');
...
function sortingazm2(){
    ...
    do{
        ...
        if(shouldswitch){
                   // parentElement.insertBefore(new,existing)  (or)  parentNode.insertBefor(new,existing)
